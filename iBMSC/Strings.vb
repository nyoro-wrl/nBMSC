Public Class Strings
    ...
    Public Class fopGeneral
        ...
        Public Shared ExtendBPM As String = "Extend number of multi-byte BPMs to 3843 (01-zz)"
        Public Shared ExtendSTOP As String = "Extend number of STOPs to 3843 (01-zz)"
